...
import { GDPRDashboardKPIs } from "@/viamentor/components/viamentor-gdpr-dashboard-kpis";
import { GDPRRequestsTable } from "@/viamentor/components/viamentor-gdpr-requests-table";
import { GDPRProcessWizard } from "@/viamentor/components/viamentor-gdpr-process-wizard";
import { GDPRConsentManagement } from "@/viamentor/components/viamentor-gdpr-consent-management";
import { GDPRConsentDetailDrawer } from "@/viamentor/components/viamentor-gdpr-consent-detail-drawer";
import {
  MOCK_DPO_STATS,
  MOCK_GDPR_REQUESTS,
  MOCK_CONSENT_TYPES,
  ...
  GDPRRequest,
  RequestStatus,
} from "@/viamentor/data/viamentor-gdpr-data";
