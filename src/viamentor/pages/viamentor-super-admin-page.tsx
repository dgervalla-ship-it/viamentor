...
import {
  ...
  getSectionTitles,
} from "@/viamentor/data/viamentor-super-admin-quick-actions";
import {
  mockSystemStats,
  mockTenantOverviews,
  ...
  mockSystemLogs,
  type TenantOverview,
} from "@/viamentor/data/viamentor-super-admin-data";
import {
  superAdminI18n,
  type SuperAdminLocale,
} from "@/viamentor/data/viamentor-super-admin-i18n";
...
const RevenueUsageMetrics = lazy(
  () => import("@/viamentor/components/viamentor-revenue-usage-metrics")
);
const TenantActionsDialog = lazy(
  () => import("@/viamentor/components/viamentor-tenant-actions-dialog")
);
const CriticalAlertsNotifications = lazy(
  () => import("@/viamentor/components/viamentor-critical-alerts-notifications")
);
const SuperAdminWelcomeBanner = lazy(
  () => import("@/viamentor/components/viamentor-super-admin-welcome-banner")
);
const QuickActionsGrid = lazy(
  () => import("@/viamentor/components/viamentor-quick-actions-grid")
);
