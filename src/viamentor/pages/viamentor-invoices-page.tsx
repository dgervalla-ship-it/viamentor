...
import { Invoice, PaymentMethod } from "@/viamentor/data/viamentor-invoices-data";
import {
  MOCK_INVOICES,
  MOCK_PAYMENT_METHODS,
  MOCK_DUNNING_CONFIG,
  MOCK_EMAIL_TEMPLATES,
} from "@/viamentor/data/viamentor-invoices-data";
import { InvoicesTable } from "@/viamentor/components/viamentor-invoices-table";
import { InvoiceDetail } from "@/viamentor/components/viamentor-invoice-detail";
import { PaymentMethodsTable } from "@/viamentor/components/viamentor-payment-methods-table";
import { DunningManagement } from "@/viamentor/components/viamentor-dunning-management";
