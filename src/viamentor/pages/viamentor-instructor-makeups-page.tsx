...
import { InstructorMakeupsStats } from "@/viamentor/components/viamentor-instructor-makeups-stats";
import { InstructorMakeupsTable } from "@/viamentor/components/viamentor-instructor-makeups-table";
import { ExtendDeadlineDialog } from "@/viamentor/components/viamentor-extend-deadline-dialog";
import { CancelCreditDialog } from "@/viamentor/components/viamentor-cancel-credit-dialog";
import { MakeupDetailSheet } from "@/viamentor/components/viamentor-makeup-detail-sheet";
import {
  ProposeGroupMakeupDialog,
  type GroupMakeupProposal,
} from "@/viamentor/components/viamentor-propose-group-makeup-dialog";
import {
  GroupMakeupsList,
  type GroupMakeup,
} from "@/viamentor/components/viamentor-group-makeups-list";
import {
  MOCK_INSTRUCTOR_STUDENTS_MAKEUPS,
  MOCK_INSTRUCTOR_MAKEUPS_GLOBAL_STATS,
  type StudentMakeupsStats,
} from "@/viamentor/data/viamentor-instructor-makeups-data";
