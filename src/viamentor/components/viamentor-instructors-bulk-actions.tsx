...
import { MOCK_MESSAGE_TEMPLATES } from "@/viamentor/data/viamentor-instructors-availability-data";
import type { InstructorStatus } from "@/viamentor/data/viamentor-instructors-realtime-hook";
