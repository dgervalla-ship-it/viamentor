...
import type { InstructorLesson } from "@/viamentor/data/viamentor-instructor-detail-data";
import type { InstructorDetailLocale } from "@/viamentor/data/viamentor-instructor-detail-i18n";
import { useInstructorDetailTranslations } from "@/viamentor/data/viamentor-instructor-detail-i18n";
