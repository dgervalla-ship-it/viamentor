...
import { SidebarHeader } from "@/viamentor/components/viamentor-sidebar-header";
import { SidebarNavigation } from "@/viamentor/components/viamentor-sidebar-navigation";
import { SidebarFooter } from "@/viamentor/components/viamentor-sidebar-footer";
import {
  NAVIGATION_BY_ROLE,
  MOCK_CURRENT_USER,
  MOCK_API_STATUS,
  SIDEBAR_I18N,
  MOCK_BADGE_COUNTS,
} from "@/viamentor/data/viamentor-sidebar-navigation-data";
import {
