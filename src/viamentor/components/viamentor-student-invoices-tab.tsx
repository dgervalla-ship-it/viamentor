...
import type { StudentInvoice } from "@/viamentor/data/viamentor-student-detail-data";
import { getInvoiceStatusColor } from "@/viamentor/data/viamentor-student-detail-data";
import type { StudentDetailLocale } from "@/viamentor/data/viamentor-student-detail-i18n";
import {
  useStudentDetailTranslations,
  formatCurrency,
  formatDate,
} from "@/viamentor/data/viamentor-student-detail-i18n";
