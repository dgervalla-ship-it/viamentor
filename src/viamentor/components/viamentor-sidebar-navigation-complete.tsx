...
import { SidebarSection } from "@/viamentor/components/viamentor-sidebar-section";
import { NAVIGATION_BY_ROLE } from "@/viamentor/data/viamentor-navigation-config";
import {
  NAVIGATION_I18N,
  type NavigationLocale,
} from "@/viamentor/data/viamentor-navigation-i18n";
import {
  useNavigation,
  MOCK_BADGE_COUNTS,
} from "@/viamentor/data/viamentor-use-navigation";
