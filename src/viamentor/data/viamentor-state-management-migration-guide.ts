...
import { useStudents, useCreateStudent } from '@/viamentor/data/viamentor-use-students-query'
...
import { useUpdateStudentOptimistic } from '@/viamentor/data/viamentor-use-students-query'
...
import { useDeleteStudentWithUndo } from '@/viamentor/data/viamentor-use-students-query'
      ...
      tasks: [
        {
          ...
          status: "✅ DONE",
          file: "@/viamentor/data/viamentor-query-provider",
        },
        {
          task: "Créer stores Zustand centralisés",
          status: "✅ DONE",
          files: [
            "@/viamentor/data/viamentor-auth-store-unified",
            "@/viamentor/data/viamentor-ui-store-unified",
          ],
        },
        {
          task: "Créer hooks TanStack Query réutilisables",
          status: "✅ DONE",
          file: "@/viamentor/data/viamentor-use-students-query",
        },
        {
          task: "Créer API client centralisé",
          status: "⏳ TODO",
          file: "@/viamentor/lib/api-client",
        },
        {
          task: "Tester infrastructure avec page exemple",
          status: "⏳ TODO",
          file: "@/viamentor/pages/viamentor-migration-demo-page",
        },
      ],
    },
    ...
    phase2: {
      ...
      tasks: [
        ...
        },
        {
          ...
          status: "⏳ TODO",
          files: [
            "@/viamentor/pages/viamentor-students-page",
            "@/viamentor/pages/viamentor-instructors-page",
            "@/viamentor/pages/viamentor-invoices-list-page",
        ...
        },
        {
          ...
          status: "⏳ TODO",
          files: [
            "@/viamentor/pages/viamentor-student-detail-page",
            "@/viamentor/pages/viamentor-instructor-detail-page",
          ],
        },
        {
      ...
      tasks: [
        {
          ...
          status: "✅ DONE",
          file: "@/viamentor/data/viamentor-use-students-query (useUpdateStudentOptimistic)",
        },
        {
          task: "Implémenter Undo/Redo",
          status: "✅ DONE",
          file: "@/viamentor/data/viamentor-use-students-query (useDeleteStudentWithUndo)",
        },
        {
