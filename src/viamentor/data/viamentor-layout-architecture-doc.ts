...
export const LAYOUT_ARCHITECTURE_DOC = {
   ...
   */
  mainLayout: {
    path: "@/viamentor/layouts/viamentor-main-layout",
    description: "Layout racine avec Sidebar + Header + Main content",
    structure: {
      sidebar: {
        component: "@/viamentor/components/viamentor-sidebar",
        width: "280px",
        collapsible: true,
        collapsedWidth: "64px",
        features: [
      ...
      header: {
        component: "@/viamentor/components/viamentor-header",
        height: "64px (h-16)",
...
const navigationConfig = NAVIGATION_BY_ROLE[user.role]
  ...
  i18n: {
    ...
    implementation: {
      provider: "@/viamentor/components/viamentor-locale-provider",
      config: "@/viamentor/data/viamentor-i18n-config",
      usage: `
...
const text = t('common.welcome') // "Bienvenue" en FR
  ...
  themeManagement: {
    ...
    provider: "@/viamentor/components/viamentor-theme-provider",
...
useEffect(() => {
  ...
  dashboardPages: {
    school: {
      path: "@/viamentor/pages/viamentor-dashboard-school-page",
      route: "/dashboard",
      roles: [
        "Platform Admin",
        "Finance Admin",
    ...
    instructor: {
      path: "@/viamentor/pages/viamentor-dashboard-instructor-page",
    ...
    student: {
      path: "@/viamentor/pages/viamentor-dashboard-student-page",
  ...
  errorHandling: {
    errorBoundary: {
      component: "@/viamentor/components/viamentor-error-boundary",
    ...
    loadingStates: {
      component: "@/viamentor/components/viamentor-loading-page",
