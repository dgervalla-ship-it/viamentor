...
export const ANALYTICS_CENTRAL_OPTIMIZATIONS = {
  file: "@/viamentor/pages/viamentor-analytics-central-page",
...
const RevenueAnalyticsPage = lazy(
  () => import("@/viamentor/pages/viamentor-revenue-analytics-page")
);
      `,
      benefits: [
...
export const CAMPAIGNS_ANALYTICS_OPTIMIZATIONS = {
  file: "@/viamentor/pages/viamentor-campaigns-analytics-page",
...
export const FINANCIAL_ANALYTICS_OPTIMIZATIONS = {
  ...
  solutions: {
    lazyLoadingSections: {
      ...
      implementation: `
// Avant
import { RevenueAnalysisSection } from "@/viamentor/components/viamentor-revenue-analysis-section";
...
export const REVENUE_ANALYTICS_OPTIMIZATIONS = {
  ...
  solutions: {
    lazyLoadingTabs: {
      ...
      implementation: `
// Avant
import { RevenueOverviewTab } from "@/viamentor/components/viamentor-revenue-overview-tab";
import { CohortsAnalysisTab } from "@/viamentor/components/viamentor-cohorts-analysis-tab";

// Après
const RevenueOverviewTab = lazy(
  () => import("@/viamentor/components/viamentor-revenue-overview-tab")
);
const CohortsAnalysisTab = lazy(
  () => import("@/viamentor/components/viamentor-cohorts-analysis-tab")
);
const ForecastingTab = lazy(
  () => import("@/viamentor/components/viamentor-forecasting-tab")
);
const ChurnAnalysisTab = lazy(
  () => import("@/viamentor/components/viamentor-churn-analysis-tab")
);
const FinancialReports = lazy(
  () => import("@/viamentor/components/viamentor-financial-reports")
);
      `,
      benefits: [
        "5 tabs lazy loaded",
