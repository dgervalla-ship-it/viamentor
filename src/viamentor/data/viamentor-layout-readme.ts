...
\`\`\`tsx
import { ViamentorMainLayout } from "@/viamentor/layouts/viamentor-main-layout";
import { MyPage } from "@/viamentor/pages/my-page";
...
### Layout Principal
\`\`\`
@/viamentor/layouts/viamentor-main-layout
...
- \`@/viamentor/data/viamentor-header-i18n\`
- \`@/viamentor/data/viamentor-sidebar-navigation-data\`
...
Éditer \`@/viamentor/data/viamentor-sidebar-navigation-data\`:
...
Éditer \`@/viamentor/components/viamentor-header\` pour:
...
1. Créer la page: \`@/viamentor/pages/my-dashboard-page\`
...
- **Layout Architecture Doc**: \`@/viamentor/data/viamentor-layout-architecture-doc\`
