 ...
 * ```tsx
 * import { PublicContactForm } from "@/viamentor/components/viamentor-public-contact-form";
 *
 ...
 * ### Custom Validation
 * ```tsx
 * import { validateEmail, validatePhone, validateName } from "@/viamentor/data/viamentor-contact-public-data";
 *
 ...
 * ### Spam Check
 * ```tsx
 * import { checkSpam } from "@/viamentor/data/viamentor-contact-public-data";
 *
 * const formData = {
 *   firstName: "John",
 *   lastName: "Doe",
