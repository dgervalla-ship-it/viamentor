...
/**
 * 1. Service de Query Params (@/viamentor/data/viamentor-url-query-params)
 *
 * Hooks créés:
...
/**
 * Fichiers créés:
 * - @/viamentor/data/viamentor-url-query-params (service + hooks)
 * - @/viamentor/data/viamentor-multi-views-query-params-fix (documentation)
 *
 * Fichiers modifiés:
