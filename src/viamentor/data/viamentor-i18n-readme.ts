...
`,
  ...
  features: [
    ...
    "✅ Traductions centralisées dans @/viamentor/i18n/locales/",
...
import { FormatDate, FormatNumber, FormatCurrency } from "@/viamentor/components/viamentor-locale-provider";
...
// @/viamentor/data/viamentor-students-i18n
...
export const RESOURCES = {
  files: [
    "@/viamentor/i18n/locales/fr.ts - Traductions françaises",
    "@/viamentor/i18n/locales/de.ts - Traductions allemandes",
    "@/viamentor/i18n/locales/it.ts - Traductions italiennes",
    "@/viamentor/i18n/locales/en.ts - Traductions anglaises",
    "@/viamentor/i18n/validator.ts - Script validation",
    "@/viamentor/i18n/namespaces.ts - Types TypeScript",
    "@/viamentor/components/viamentor-locale-provider - Provider React",
  ],

  documentation: [
    "@/viamentor/data/viamentor-i18n-improvements - Analyse et améliorations",
    "@/viamentor/data/viamentor-i18n-implementation-guide - Guide implémentation",
    "@/viamentor/data/viamentor-i18n-readme - Ce fichier",
  ],
