...
export const MAINTENANCE_VEHICLES_INTEGRATION_DOC = {
  ...
  components: [
    "@/viamentor/components/viamentor-maintenance-task-dialog",
    "@/viamentor/pages/viamentor-maintenance-page",
    "@/viamentor/pages/viamentor-vehicle-detail-page",
  ],

  dataFiles: [
    "@/viamentor/data/viamentor-maintenance-data",
    "@/viamentor/data/viamentor-vehicles-data",
    "@/viamentor/data/viamentor-maintenance-i18n",
  ],
};
