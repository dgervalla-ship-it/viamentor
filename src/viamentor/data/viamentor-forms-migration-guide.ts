    ...
    forms: [
      {
        ...
        path: "@/viamentor/components/viamentor-create-student-wizard",
        steps: 4,
        complexity: "high",
        priority: "high",
      ...
      },
      {
        ...
        path: "@/viamentor/components/viamentor-student-informations-tab",
        steps: 1,
        complexity: "medium",
        priority: "high",
    ...
    forms: [
      {
        ...
        path: "@/viamentor/components/viamentor-create-instructor-wizard",
        steps: 3,
        complexity: "high",
        priority: "high",
        currentValidation: "React Hook Form + Zod",
      ...
      },
      {
        ...
        path: "@/viamentor/components/viamentor-instructor-informations-tab",
        steps: 1,
        complexity: "medium",
        priority: "medium",
        currentValidation: "Inline validation",
    ...
    forms: [
      {
        ...
        path: "@/viamentor/components/viamentor-book-lesson-wizard",
        steps: 4,
        complexity: "high",
        priority: "critical",
        currentValidation: "React Hook Form + Zod",
      ...
      },
      {
        ...
        path: "@/viamentor/pages/viamentor-lesson-evaluation-page",
        steps: 1,
        complexity: "medium",
        priority: "high",
        currentValidation: "React Hook Form + Zod",
    ...
    forms: [
      {
        ...
        path: "@/viamentor/components/viamentor-create-vehicle-wizard",
        steps: 4,
        complexity: "high",
        priority: "medium",
        currentValidation: "React Hook Form + Zod",
    ...
    forms: [
      {
        ...
        path: "@/viamentor/components/viamentor-record-payment-modal",
        steps: 1,
        complexity: "medium",
        priority: "critical",
        currentValidation: "React Hook Form + Zod",
      ...
      },
      {
        ...
        path: "@/viamentor/components/viamentor-import-camt-modal",
        steps: 4,
        complexity: "high",
        priority: "high",
        currentValidation: "React Hook Form + Zod",
    ...
    forms: [
      {
        ...
        path: "@/viamentor/components/viamentor-create-tenant-wizard",
        steps: 5,
        complexity: "high",
        priority: "low",
        currentValidation: "React Hook Form + Zod",
    ...
    forms: [
      {
        ...
        path: "@/viamentor/components/viamentor-onboarding-wizard",
        steps: 5,
        complexity: "high",
        priority: "medium",
        currentValidation: "React Hook Form + Zod",
