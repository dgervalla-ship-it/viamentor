...
// viamentor/i18n/hooks.ts
import { useContext } from "react";
import { LocaleContext } from "@/viamentor/components/viamentor-locale-provider";
...
export const PACKAGE_JSON_SCRIPTS = {
  scripts: {
    "i18n:validate": "tsx viamentor/i18n/validation.ts",
...
export const I18N_CHECKLIST = {
  "Phase 1 - Restructuration Fichiers": {
    ...
    tasks: [
      {
        id: "i18n-1",
        task: "Créer structure viamentor/i18n/locales/",
