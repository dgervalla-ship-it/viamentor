...
export const NAVIGATION_UPDATES: NavigationUpdate[] = [
  {
    file: "@/viamentor/data/viamentor-navigation-config",
    changes: [
  ...
  {
    file: "@/viamentor/data/viamentor-navigation-i18n",
    changes: [
...
export const UPDATE_SUMMARY = {
  ...
  filesModified: [
    ...
    "@/viamentor/data/viamentor-navigation-i18n",
  ],

  filesCreated: ["@/viamentor/data/viamentor-settings-navigation-update"],
  impact: {
