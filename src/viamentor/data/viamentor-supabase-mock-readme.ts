...
\`\`\`typescript
import { setAutoLogin } from "@/viamentor/data/viamentor-supabase-mock";
...
\`\`\`typescript
import { getAutoLogin } from "@/viamentor/data/viamentor-supabase-mock";
...
- **Page de login**: \`/login\`
- **Code source**: \`@/viamentor/data/viamentor-supabase-mock\`
