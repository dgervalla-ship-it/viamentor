...
// middleware.ts
export { middleware } from "@/viamentor/data/viamentor-rbac-middleware";
 ...
 *
 * Fichier: @/viamentor/data/viamentor-rbac-middleware
 */
...
import { checkPermission } from "@/viamentor/data/viamentor-rbac-middleware";
...
import { requirePermission, applyRLS, createSuccessResponse } from "@/viamentor/data/viamentor-api-guards";
...
// app/api/students/route.ts
import { requirePermission, validateRequestBody, createSuccessResponse } from "@/viamentor/data/viamentor-api-guards";
import { CreateStudentSchema } from "@/viamentor/data/viamentor-student-wizard-schemas";
...
// app/api/students/route.ts
import { apiGuard, applyRLS, createSuccessResponse } from "@/viamentor/data/viamentor-api-guards";
...
// middleware.ts
import { refreshAccessToken } from "@/viamentor/data/viamentor-auth-improvements";
...
import { enable2FA } from "@/viamentor/data/viamentor-auth-improvements";
...
import { 
  ...
  registerDevice,
  isKnownDevice,
} from "@/viamentor/data/viamentor-auth-improvements";
  ...
  "Phase 1 - RBAC Server-Side (CRITIQUE)": {
    ...
    tasks: [
      ...
      },
      {
        ...
        status: "pending" as const,
        file: "@/viamentor/data/viamentor-rbac-middleware",
      },
      {
        id: "rbac-3",
  ...
  "Phase 2 - API Protection (CRITIQUE)": {
    ...
    tasks: [
      ...
      },
      {
        ...
        status: "pending" as const,
        file: "@/viamentor/data/viamentor-api-guards",
      },
    ],
  },
  ...
  "Phase 3 - Auth Improvements (MAJEUR)": {
    ...
    tasks: [
      ...
      },
      {
        ...
        status: "pending" as const,
        file: "@/viamentor/data/viamentor-auth-improvements",
      },
      {
        id: "auth-6",
