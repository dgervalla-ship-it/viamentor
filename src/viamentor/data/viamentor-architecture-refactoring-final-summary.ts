...
export const REUSABLE_COMPONENTS = [
  {
    name: "PageContainer",
    path: "@/viamentor/components/viamentor-page-container",
  ...
  {
    name: "ErrorContainer",
    path: "@/viamentor/components/viamentor-error-container",
  ...
  {
    name: "DemoLayout",
    path: "@/viamentor/components/viamentor-demo-layout",
  ...
  {
    name: "DemoHeader",
    path: "@/viamentor/components/viamentor-demo-header",
  ...
  {
    name: "DemoSection",
    path: "@/viamentor/components/viamentor-demo-section",
  ...
  },
  {
    ...
    path: "@/viamentor/components/viamentor-demo-feature-list",
  ...
  {
    name: "DemoStatsGrid",
    path: "@/viamentor/components/viamentor-demo-stats-grid",
