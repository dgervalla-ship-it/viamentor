...
import { Trans } from "@/viamentor/data/viamentor-locale-provider";
...
import {
  ...
  FormatCurrency,
  FormatDate,
} from "@/viamentor/data/viamentor-locale-provider";
 ...
 * - @/viamentor/data/viamentor-locale-provider
 * - @/viamentor/data/viamentor-i18n-config
 * - @/viamentor/data/viamentor-students-i18n
 * - @/viamentor/data/viamentor-naming-conventions
 */
