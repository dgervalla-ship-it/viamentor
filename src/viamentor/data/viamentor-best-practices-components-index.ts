...
export const BEST_PRACTICES_COMPONENTS = {
  helpTooltip: {
    path: "@/viamentor/components/viamentor-help-tooltip",
    ...
    usage: `import { HelpTooltip } from "@/viamentor/components/viamentor-help-tooltip"
...
<Label>
  ...
  wizardTemplate: {
    path: "@/viamentor/components/viamentor-wizard-template",
    ...
    usage: `import { Wizard, WizardStep } from "@/viamentor/components/viamentor-wizard-template"
...
/>`,
  ...
  bulkActions: {
    path: "@/viamentor/components/viamentor-bulk-actions",
    ...
    usage: `import { BulkActions } from "@/viamentor/components/viamentor-bulk-actions"
...
/>`,
  ...
  studentCardExample: {
    path: "@/viamentor/components/viamentor-student-card-example",
    ...
    usage: `import { StudentCard } from "@/viamentor/components/viamentor-student-card-example"
  ...
  documentation: [
    {
      ...
      path: "@/viamentor/data/viamentor-architecture-index",
      description: "Documentation complète architecture",
    },
    {
      name: "Design System Audit",
      path: "@/viamentor/data/viamentor-architecture-06-best-practices",
      description: "Audit complet UI/UX avec recommandations",
    },
    {
      name: "Security Audit",
      path: "@/viamentor/data/viamentor-security-audit",
      description: "Audit sécurité OWASP Top 10",
    },
    {
      name: "Testing Strategy",
      path: "@/viamentor/data/viamentor-testing-strategy",
