  ...
  pages: [
    {
      ...
      path: "@/viamentor/pages/viamentor-not-found-page",
      route: "/not-found",
      catchAllRoute: "/*",
      description:
    ...
    },
    {
      ...
      path: "@/viamentor/pages/viamentor-unauthorized-page",
      route: "/unauthorized",
    ...
    },
    {
      ...
      path: "@/viamentor/pages/viamentor-error-page",
      route: "/error",
      description:
    ...
    },
    {
      ...
      path: "@/viamentor/pages/viamentor-maintenance-page",
      route: "/maintenance",
