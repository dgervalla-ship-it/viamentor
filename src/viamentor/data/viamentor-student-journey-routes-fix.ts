...
export const studentJourneyRoutesFix = {
  ...
  pages: [
    {
      path: "@/viamentor/pages/viamentor-student-journey-page",
    ...
    {
      path: "@/viamentor/pages/viamentor-student-next-steps-page",
    ...
    {
      path: "@/viamentor/pages/viamentor-student-milestones-page",
  ...
  filesModified: [
    {
      path: "@/viamentor/prototypes/viamentor-system-prototype",
      changes: [
