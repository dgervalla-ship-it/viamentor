...
export const NEW_COMPONENTS = {
  userRightsActions: {
    path: "@/viamentor/components/viamentor-gdpr-user-rights-actions",
    ...
    i18n: ["fr", "de", "it", "en"],
    usage: `
      import { GDPRUserRightsActions } from "@/viamentor/components/viamentor-gdpr-user-rights-actions";
  ...
  complianceGuide: {
    path: "@/viamentor/data/viamentor-gdpr-compliance-guide",
...
export const EXISTING_PAGES = {
  compliance: {
    ...
    file: "@/viamentor/pages/viamentor-gdpr-compliance-page",
    status: "✅ Conforme",
  ...
  privacyPolicy: {
    ...
    file: "@/viamentor/pages/viamentor-privacy-policy-page",
    status: "✅ Conforme",
  ...
  cookiesPolicy: {
    path: "/cookies",
    file: "@/viamentor/pages/viamentor-cookies-policy-page",
    status: "✅ Conforme",
  ...
  legalTerms: {
    ...
    file: "@/viamentor/pages/viamentor-legal-terms-page",
    status: "✅ Conforme",
  ...
  contactPublic: {
    path: "/contact",
    file: "@/viamentor/pages/viamentor-contact-public-page",
    status: "✅ Conforme",
  ...
  aboutPage: {
    path: "/a-propos",
    file: "@/viamentor/pages/viamentor-about-page",
    status: "✅ Conforme",
  ...
  thankYou: {
    path: "/merci",
    file: "@/viamentor/pages/viamentor-thank-you-page",
    status: "✅ Conforme",
  ...
  noAuthInfo: {
    path: "/no-auth-info",
    file: "@/viamentor/pages/viamentor-no-auth-info-page",
    status: "✅ Conforme",
...
export const EXISTING_COMPONENTS = {
  cookieBanner: {
    path: "@/viamentor/components/viamentor-cookie-banner",
    status: "✅ Conforme",
  ...
  consentManagement: {
    path: "@/viamentor/components/viamentor-gdpr-consent-management",
    status: "✅ Conforme",
  ...
  requestsTable: {
    path: "@/viamentor/components/viamentor-gdpr-requests-table",
    status: "✅ Conforme",
  ...
  processWizard: {
    path: "@/viamentor/components/viamentor-gdpr-process-wizard",
    status: "✅ Conforme",
  ...
  dashboardKPIs: {
    path: "@/viamentor/components/viamentor-gdpr-dashboard-kpis",
    status: "✅ Conforme",
...
export const GDPR_DATA = {
  mockData: {
    path: "@/viamentor/data/viamentor-gdpr-data",
    status: "✅ Complet",
  ...
  schemas: {
    path: "@/viamentor/data/viamentor-gdpr-schemas",
    status: "✅ Complet",
...
export const GDPR_ACTIONS = {
  "1_consent": {
    ...
    components: [
      "@/viamentor/components/viamentor-gdpr-user-rights-actions",
      "@/viamentor/components/viamentor-cookie-banner",
      "@/viamentor/components/viamentor-gdpr-consent-management",
    ],
  },
  ...
  "2_deletion": {
    ...
    components: [
      "@/viamentor/components/viamentor-gdpr-user-rights-actions",
      "@/viamentor/components/viamentor-gdpr-process-wizard",
    ],
  ...
  "3_portability": {
    ...
    components: ["@/viamentor/components/viamentor-gdpr-user-rights-actions"],
...
export const INTEGRATION_GUIDE = {
  ...
  cookieBanner: {
    ...
    code: `
      import { CookieBanner } from "@/viamentor/components/viamentor-cookie-banner";
