...
export const TECHNICAL_DOCUMENTATION = {
  ...
  architecture: {
    ...
    file: "@/viamentor/data/viamentor-docs-architecture-overview",
  ...
  routing: {
    ...
    file: "@/viamentor/data/viamentor-docs-routing-guide",
  ...
  testing: {
    title: "Testing Guide",
    file: "@/viamentor/data/viamentor-docs-testing-guide",
  ...
  naming: {
    ...
    file: "@/viamentor/data/viamentor-naming-conventions",
  ...
  i18n: {
    ...
    file: "@/viamentor/data/viamentor-docs-i18n-complete-guide",
...
export const DESIGN_SYSTEM_DOCUMENTATION = {
  ...
  reference: {
    ...
    file: "@/viamentor/data/viamentor-design-system-reference",
  ...
  tokens: {
    title: "Design Tokens",
    file: "@/viamentor/data/viamentor-design-system-tokens",
  ...
  theme: {
    ...
    file: "@/viamentor/data/viamentor-theme-config",
...
export const DEVELOPMENT_GUIDES = {
  ...
  validation: {
    ...
    file: "@/viamentor/data/viamentor-validation-complete-guide",
  ...
  stateManagement: {
    ...
    file: "@/viamentor/data/viamentor-state-management-migration-guide",
  ...
  responsive: {
    ...
    file: "@/viamentor/data/viamentor-mobile-optimization-guide",
  ...
  security: {
    ...
    file: "@/viamentor/data/viamentor-security-readme",
...
export const USER_GUIDES = {
  ...
  schoolAdmin: {
    ...
    file: "@/viamentor/data/viamentor-docs-user-school-admin",
  ...
  secretary: {
    ...
    file: "@/viamentor/data/viamentor-docs-user-secretary",
  ...
  instructor: {
    ...
    file: "@/viamentor/data/viamentor-docs-user-instructor",
  ...
  student: {
    ...
    file: "@/viamentor/data/viamentor-docs-user-student",
  ...
  faq: {
    title: "FAQ Complète",
    file: "@/viamentor/data/viamentor-docs-faq",
...
export const API_DOCUMENTATION = {
  ...
  endpoints: {
    ...
    file: "@/viamentor/data/viamentor-docs-api-reference",
  ...
  schemas: {
    ...
    file: "@/viamentor/data/viamentor-docs-schemas-reference",
  ...
  queryHooks: {
    ...
    file: "@/viamentor/data/viamentor-docs-query-hooks-reference",
  ...
  stores: {
    ...
    file: "@/viamentor/data/viamentor-docs-stores-reference",
  ...
  examples: {
    ...
    file: "@/viamentor/data/viamentor-docs-usage-examples",
...
export const DEVELOPER_GUIDES = {
  ...
  contribution: {
    ...
    file: "@/viamentor/data/viamentor-docs-contributing",
  ...
  setup: {
    ...
    file: "@/viamentor/data/viamentor-docs-setup-environment",
  ...
  debugging: {
    ...
    file: "@/viamentor/data/viamentor-docs-debugging",
  ...
  performance: {
    ...
    file: "@/viamentor/data/viamentor-docs-performance",
  ...
  securityDev: {
    ...
    file: "@/viamentor/data/viamentor-docs-security-dev",
...
export const FUNCTIONAL_MODULES = {
  ...
  lessons: {
    ...
    file: "@/viamentor/data/viamentor-lessons-module-guide",
  ...
  planning: {
    ...
    file: "@/viamentor/data/viamentor-planning-features-guide",
  ...
  makeups: {
    ...
    file: "@/viamentor/data/viamentor-makeups-system-guide",
  ...
  pixels: {
    ...
    file: "@/viamentor/data/viamentor-pixels-monitoring-guide",
...
export const PROJECT_MANAGEMENT = {
  ...
  changelog: {
    title: "Changelog",
    file: "@/viamentor/data/viamentor-docs-changelog",
  ...
  deployment: {
    ...
    file: "@/viamentor/data/viamentor-docs-deployment",
...
export const DOCUMENTATION_RESOURCES = {
  ...
  internal: [
    "Tous les guides dans @/viamentor/data/viamentor-docs-*",
    "Conventions dans @/viamentor/data/viamentor-naming-conventions",
    "Design system dans @/viamentor/data/viamentor-design-system-*",
  ],
