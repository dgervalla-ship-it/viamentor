...
export const CREATED_FILES = {
  ...
  service: "@/viamentor/data/viamentor-contextual-navigation",
  ...
  component: "@/viamentor/components/viamentor-contextual-navigation-bar",
  ...
  // Documentation
  documentation: "@/viamentor/data/viamentor-contextual-navigation-fix",
...
export const MODIFIED_FILES = {
  // Page détail élève
  studentDetailPage: "@/viamentor/pages/viamentor-student-detail-page",
  changes: [
...
import { buildContextualUrl } from "@/viamentor/data/viamentor-contextual-navigation";
