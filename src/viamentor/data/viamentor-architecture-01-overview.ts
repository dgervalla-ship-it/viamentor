...
/**
 * 1.1 Environnement Actuel : Viamentor
 *
 * Viamentor est actuellement développé dans l'environnement Viamentor,
 * une plateforme de prototypage rapide qui utilise React Router.
 *
 * ⚠️ IMPORTANT : Ce n'est PAS la structure de production finale !
 *
 * Avantages de Viamentor :
 * - Prototypage rapide
...
export const VIAMENTOR_CONTEXT = {
  purpose: "Prototypage rapide et validation UI/UX",
  router: "React Router v6",
  rendering: "Client-side only (CSR)",
  deployment: "Plateforme Viamentor",
  production_ready: false,
  migration_required: true,
} as const;

/**
 * 1.2 Structure Actuelle (Viamentor)
 *
 * viamentor/
