...
- @/viamentor/pages/viamentor-dashboard-school-page (to update) - Dashboard école visible
- @/viamentor/pages/viamentor-students-page (to update) - Page élèves
- @/viamentor/pages/viamentor-instructors-page (to update) - Page moniteurs
- @/viamentor/pages/viamentor-planning-page (to update) - Page planning
- @/viamentor/pages/viamentor-vehicles-page (to update) - Page véhicules
- @/viamentor/pages/viamentor-invoices-list-page (to update) - Page factures
- @/viamentor/pages/viamentor-student-detail-page (to update) - Détail élève
- @/viamentor/pages/viamentor-instructor-detail-page (to update) - Détail moniteur

### Composants globaux critiques
- @/viamentor/components/viamentor-header (to update) - Header global
- @/viamentor/components/viamentor-sidebar (to update) - Sidebar navigation
- @/viamentor/components/viamentor-quick-actions-bar (to update) - Actions rapides mobile

### Composants réutilisables
- @/viamentor/components/viamentor-stats-card (to update) - Cards statistiques
- @/viamentor/components/viamentor-students-table (to update) - Tables élèves
- @/viamentor/components/viamentor-instructors-table (to update) - Tables moniteurs
- @/viamentor/components/viamentor-create-student-wizard (to update) - Wizards
- @/viamentor/components/viamentor-create-instructor-wizard (to update) - Wizards

### Layout
- @/viamentor/layouts/viamentor-main-layout (to update) - Layout principal
