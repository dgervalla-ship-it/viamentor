...
import type { StudentMakeupsLocale } from "@/polymet/data/viamentor-student-makeups-i18n";
import { studentMakeupsTranslations } from "@/polymet/data/viamentor-student-makeups-i18n";
