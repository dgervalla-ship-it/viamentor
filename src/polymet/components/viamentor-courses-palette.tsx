...
import { DraggableTypeCard } from "@/polymet/components/viamentor-draggable-type-card";
import { CourseType } from "@/polymet/data/viamentor-courses-types-data";
import { CourseCategory } from "@/polymet/data/viamentor-courses-categories-data";
