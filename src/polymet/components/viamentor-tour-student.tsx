/**
 * VIAMENTOR Student Tour
 *
 * Tour guidé 5 steps pour Élève
 * Focus sur progression, réservation, factures, profil
 *
 * @module components/viamentor-tour-student
 * @version 1.0.0
 */
...
export function StudentTour({
  ...
  const tourId = "student-tour";
  const t = getTourTranslations("student", locale);

  const steps: TourStep[] = [
    {
      target: '[data-tour-id="student-dashboard"]',
    ...
    {
      target: '[data-tour-id="book-lesson-button"]',
      title: t.steps.booking.title,
      content: t.steps.booking.content,
      placement: "bottom",
      spotlightClicks: true,
    },
    {
      target: '[data-tour-id="progression-tracker"]',
      title: t.steps.progression.title,
      content: t.steps.progression.content,
      placement: "right",
    },
    {
      target: '[data-tour-id="student-invoices"]',
      title: t.steps.invoices.title,
      content: t.steps.invoices.content,
      placement: "left",
    },
    {
      target: '[data-tour-id="student-profile"]',
