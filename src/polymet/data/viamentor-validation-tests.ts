...
import { emailValidation } from '@/polymet/data/viamentor-validation-improvements';
...
import { swissPhoneValidation } from '@/polymet/data/viamentor-validation-improvements';
...
describe('swissPhoneValidation', () => {
  ...
  ageValidation: {
    ...
    code: `
import { describe, it, expect } from 'vitest';
import { ageValidation } from '@/polymet/data/viamentor-validation-improvements';
...
describe('ageValidation', () => {
  ...
  swissLicenseValidation: {
    ...
    code: `
import { describe, it, expect } from 'vitest';
import { swissLicenseValidation } from '@/polymet/data/viamentor-validation-improvements';
...
describe('swissLicenseValidation', () => {
  ...
  swissIBANValidation: {
    ...
    code: `
import { describe, it, expect } from 'vitest';
import { swissIBANValidation } from '@/polymet/data/viamentor-validation-improvements';
...
export const consolidatedSchemasTests = {
  baseLessonSchema: {
    ...
    code: `
import { describe, it, expect } from 'vitest';
import { BaseLessonSchema } from '@/polymet/data/viamentor-validation-improvements';
...
import { describe, it, expect } from 'vitest';
import { z } from 'zod';
import { conditionalValidation, swissIBANValidation } from '@/polymet/data/viamentor-validation-improvements';
