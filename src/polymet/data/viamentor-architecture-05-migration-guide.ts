 ...
 * Guide de Migration Polymet → Next.js 15
 */

export const MIGRATION_MAPPING = {
  // Polymet → Next.js
  pages: {
    from: "polymet/pages/viamentor-students-page",
  ...
  components: {
    from: "polymet/components/viamentor-students-table",
  ...
  layouts: {
    from: "polymet/layouts/viamentor-main-layout",
