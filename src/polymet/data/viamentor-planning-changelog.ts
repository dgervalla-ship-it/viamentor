...
export const CHANGELOG_V2 = {
  ...
  features: [
...

    {
      ...
      impact: "medium",
      files: ["@/polymet/components/viamentor-planning-calendar"],
...

    {
      ...
      impact: "medium",
      files: ["@/polymet/pages/viamentor-planning-page"],
...

    {
      ...
      impact: "low",
      files: ["@/polymet/data/viamentor-planning-i18n"],
    },
  ],
...
interface PlanningCalendarProps {
  ...
  documentation: [
    "@/polymet/data/viamentor-planning-features-guide - Guide complet des fonctionnalités",
    "@/polymet/data/viamentor-planning-changelog - Changelog détaillé",
  ],
