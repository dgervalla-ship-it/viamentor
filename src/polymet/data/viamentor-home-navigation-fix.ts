 ...
 *
 * Fichier : @/polymet/components/viamentor-smart-home-redirect
 */
 ...
 *
 * // 2. Créer @/polymet/pages/viamentor-fleet-manager-page
 *
 * // 3. Dans le prototype
 * <Route
 *   path="/fleet-manager"
...
export const MODIFIED_FILES = {
  created: [
    "@/polymet/components/viamentor-smart-home-redirect",
    "@/polymet/data/viamentor-home-navigation-fix",
  ],
