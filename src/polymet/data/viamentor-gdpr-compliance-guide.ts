...
export const CONSENT_MANAGEMENT = {
  ...
  implementation: {
    component: "@/polymet/components/viamentor-gdpr-user-rights-actions",
...
export const RIGHT_TO_BE_FORGOTTEN = {
  ...
  implementation: {
    component: "@/polymet/components/viamentor-gdpr-user-rights-actions",
    workflow: "@/polymet/components/viamentor-gdpr-process-wizard",
...
export const BREACH_NOTIFICATIONS = {
  ...
  implementation: {
    component: "@/polymet/components/viamentor-gdpr-user-rights-actions",
    storage: "@/polymet/data/viamentor-gdpr-data",
...
export const COOKIE_MANAGEMENT = {
  ...
  implementation: {
    banner: "@/polymet/components/viamentor-cookie-banner",
...
export const GDPR_PAGES = {
  compliance: {
    ...
    component: "@/polymet/pages/viamentor-gdpr-compliance-page",
  ...
  privacyPolicy: {
    ...
    component: "@/polymet/pages/viamentor-privacy-policy-page",
  ...
  cookiesPolicy: {
    path: "/cookies",
    component: "@/polymet/pages/viamentor-cookies-policy-page",
  ...
  legalTerms: {
    ...
    component: "@/polymet/pages/viamentor-legal-terms-page",
