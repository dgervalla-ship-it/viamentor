 ...
 * - @/polymet/components/viamentor-responsive-page-wrapper
 * - @/polymet/data/viamentor-responsive-utils (+ useMediaQuery)
 * - @/polymet/data/viamentor-touch-gestures (swipe, long press, pinch)
 * - @/polymet/components/viamentor-responsive-dashboard (template)
 * - @/polymet/components/viamentor-mobile-wizard (template)
 * - @/polymet/components/viamentor-swipeable-card (template)
 */
...
export const DASHBOARD_MIGRATIONS = [
  {
    file: "@/polymet/pages/viamentor-dashboard-school-page",
    priority: "HIGH",
    sections: [
      {
        id: "stats",
  ...
  {
    file: "@/polymet/pages/viamentor-dashboard-instructor-page",
    priority: "HIGH",
    sections: [
  ...
  {
    file: "@/polymet/pages/viamentor-dashboard-student-page",
    priority: "HIGH",
    sections: [
  ...
  {
    file: "@/polymet/pages/viamentor-super-admin-page",
    priority: "MEDIUM",
    sections: [
  ...
  {
    file: "@/polymet/pages/viamentor-platform-admin-page",
    priority: "MEDIUM",
    sections: [
  ...
  {
    file: "@/polymet/pages/viamentor-school-admin-page",
    priority: "MEDIUM",
    sections: [
      { id: "overview", label: "Vue d'ensemble", icon: "LayoutDashboardIcon" },
  ...
  {
    file: "@/polymet/pages/viamentor-secretary-dashboard-page",
    priority: "HIGH",
    sections: [
      { id: "today", label: "Aujourd'hui", icon: "CalendarIcon" },
  ...
  {
    file: "@/polymet/pages/viamentor-finance-manager-page",
    priority: "HIGH",
    sections: [
  ...
  {
    file: "@/polymet/pages/viamentor-instructor-manager-page",
    priority: "MEDIUM",
    sections: [
  ...
  {
    file: "@/polymet/pages/viamentor-marketing-manager-page",
    priority: "MEDIUM",
    sections: [
  ...
  {
    file: "@/polymet/pages/viamentor-accountant-page",
    priority: "MEDIUM",
    sections: [
      { id: "overview", label: "Vue d'ensemble", icon: "LayoutDashboardIcon" },
...
export const ANALYTICS_MIGRATIONS = [
  ...
  {
    file: "@/polymet/pages/viamentor-exams-analytics-page",
    priority: "MEDIUM",
    charts: [
      "Success Rates",
      "Failure Analysis",
  ...
  {
    file: "@/polymet/pages/viamentor-reviews-dashboard-page",
    priority: "MEDIUM",
    charts: [
      "Rating Distribution",
      "Sentiment Analysis",
 ...
 * APRÈS:
 * ```tsx
 * import { MobileWizard } from "@/polymet/components/viamentor-mobile-wizard";
 *
 * <Dialog>
 *   <MobileWizard
 *     steps={[
...
export const WIZARD_MIGRATIONS = [
  {
    file: "@/polymet/components/viamentor-create-student-wizard",
    priority: "HIGH",
    steps: 4,
    notes: "Wizard 4 steps - Ajouter swipe navigation + validation inline",
  },
  {
    file: "@/polymet/components/viamentor-create-instructor-wizard",
    priority: "HIGH",
    steps: 3,
    notes: "Wizard 3 steps - Swipe + progress indicator mobile",
  },
  {
    file: "@/polymet/components/viamentor-create-vehicle-wizard",
    priority: "MEDIUM",
    steps: 4,
    notes: "Wizard 4 steps - Touch-friendly form inputs",
  },
  {
    file: "@/polymet/components/viamentor-create-tenant-wizard",
    priority: "MEDIUM",
    steps: 5,
    notes: "Wizard 5 steps - Swipe + compact mobile layout",
  },
  {
    file: "@/polymet/components/viamentor-book-lesson-wizard",
    priority: "HIGH",
    steps: 4,
    notes: "Wizard réservation - Calendar picker mobile optimisé",
  },
  {
    file: "@/polymet/components/viamentor-onboarding-wizard",
    priority: "HIGH",
    steps: 5,
    notes: "Onboarding initial - Swipe + animations smooth",
  },
  {
    file: "@/polymet/components/viamentor-create-promotion-wizard",
    priority: "LOW",
    steps: 3,
    notes: "Wizard promotion - Forms adaptatifs",
  },
  {
    file: "@/polymet/components/viamentor-create-package-wizard",
    priority: "LOW",
    steps: 3,
    notes: "Wizard package - Touch gestures",
  },
  {
    file: "@/polymet/components/viamentor-create-theory-course-wizard",
    priority: "MEDIUM",
    steps: 3,
 ...
 * APRÈS:
 * ```tsx
 * import { useMediaQuery } from "@/polymet/data/viamentor-responsive-utils";
 * import { SwipeableCard } from "@/polymet/components/viamentor-swipeable-card";
 *
...
export const TABLE_MIGRATIONS = [
  {
    file: "@/polymet/components/viamentor-students-table",
    priority: "HIGH",
    notes: "Table élèves - Convertir en cards mobile avec swipe actions",
  },
  {
    file: "@/polymet/components/viamentor-instructors-table",
    priority: "HIGH",
    notes: "Table moniteurs - Cards mobile + swipe",
  },
  {
    file: "@/polymet/components/viamentor-vehicles-table",
    priority: "MEDIUM",
    notes: "Table véhicules - Cards mobile + swipe",
  },
  {
    file: "@/polymet/components/viamentor-invoices-table",
    priority: "HIGH",
    notes: "Table factures - Cards mobile + swipe",
  },
  {
    file: "@/polymet/components/viamentor-invoices-list-table",
    priority: "HIGH",
    notes: "Liste factures - Cards mobile + filtres adaptatifs",
  },
  {
    file: "@/polymet/components/viamentor-tenants-table-view",
    priority: "MEDIUM",
    notes: "Table tenants - Cards mobile + swipe",
  },
  {
    file: "@/polymet/components/viamentor-payments-stats-cards",
    priority: "MEDIUM",
...
export const GRID_MIGRATIONS = [
  {
    file: "@/polymet/components/viamentor-students-grid-view",
    priority: "HIGH",
    notes: "Grid élèves - 1/2/3 colonnes + swipe actions",
  },
  {
    file: "@/polymet/components/viamentor-instructors-grid-view",
    priority: "HIGH",
    notes: "Grid moniteurs - 1/2/3 colonnes + swipe",
  },
  {
    file: "@/polymet/components/viamentor-vehicles-grid-view",
    priority: "MEDIUM",
    notes: "Grid véhicules - 1/2/3 colonnes + swipe",
  },
  {
    file: "@/polymet/components/viamentor-tenants-grid-view",
    priority: "MEDIUM",
...
export const DETAIL_PAGE_MIGRATIONS = [
  {
    file: "@/polymet/pages/viamentor-student-detail-page",
    priority: "HIGH",
    tabs: 6,
    notes: "6 tabs - Tabs scrollables mobile + swipe navigation",
  },
  {
    file: "@/polymet/pages/viamentor-instructor-detail-page",
    priority: "HIGH",
    tabs: 4,
    notes: "4 tabs - Mobile optimized + swipe",
  },
  {
    file: "@/polymet/pages/viamentor-vehicle-detail-page",
    priority: "MEDIUM",
    tabs: 5,
    notes: "5 tabs - Tabs mobile + swipe",
  },
  {
    file: "@/polymet/pages/viamentor-tenant-detail-page",
    priority: "MEDIUM",
    tabs: 6,
