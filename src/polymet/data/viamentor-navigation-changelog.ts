...
export const NAVIGATION_CHANGELOG = {
  ...
  changes: {
    added: [
      {
        file: "@/polymet/data/viamentor-sidebar-navigation-optimized",
        description:
      ...
      {
        file: "@/polymet/components/viamentor-sidebar-navigation-demo",
      ...
      {
        file: "@/polymet/pages/viamentor-navigation-demo-page",
      ...
      {
        file: "@/polymet/data/viamentor-navigation-solution-summary",
      ...
      {
        file: "@/polymet/data/viamentor-navigation-readme",
      ...
      {
        file: "@/polymet/data/viamentor-navigation-changelog",
    ...
    modified: [
      {
        file: "@/polymet/components/viamentor-header",
      ...
      {
        file: "@/polymet/layouts/viamentor-main-layout",
      ...
      {
        file: "@/polymet/components/viamentor-sidebar",
      ...
      {
        file: "@/polymet/prototypes/viamentor-system-prototype",
