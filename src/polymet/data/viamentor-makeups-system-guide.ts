 ...
 *
 * Fichiers:
 * - @/polymet/data/viamentor-makeups-data (types, mock data)
 * - @/polymet/components/viamentor-makeups-config-form (formulaire config)
 */
 ...
 *
 * Fichiers:
 * - @/polymet/components/viamentor-makeups-email-templates (éditeur WYSIWYG)
 */
 ...
 *
 * Fichiers:
 * - @/polymet/components/viamentor-makeups-analytics-dashboard
 */
