...
export const DOCUMENTATION_INDEX = {
  part1: {
    file: "@/polymet/data/viamentor-architecture-01-overview",
    title: "Vue d'ensemble et Contexte",
    topics: [
      "Contexte Polymet (environnement actuel)",
  ...
  part2: {
    file: "@/polymet/data/viamentor-architecture-02-nextjs-structure",
  ...
  part3: {
    file: "@/polymet/data/viamentor-architecture-03-api-server-actions",
  ...
  part4: {
    file: "@/polymet/data/viamentor-architecture-04-middleware-auth",
  ...
  part5: {
    file: "@/polymet/data/viamentor-architecture-05-migration-guide",
    title: "Guide de Migration Polymet → Next.js",
    topics: [
      "Mapping Polymet → Next.js",
  ...
  part6: {
    file: "@/polymet/data/viamentor-architecture-06-best-practices",
...
export const EXECUTIVE_SUMMARY = {
  situation: {
    current: "Prototype Polymet avec React Router (non production-ready)",
...
export const FAQ = [
  {
    q: "Pourquoi migrer de Polymet vers Next.js ?",
    a: "Polymet est un outil de prototypage, pas une solution de production. Next.js offre performance, SEO, scalabilité et maintenabilité nécessaires pour une application en production.",
  },
  {
