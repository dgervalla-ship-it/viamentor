...
export const I18N_CHECKLIST = {
  "Phase 1 - Structure Centralisée": {
    ...
    tasks: [
      {
        id: "i18n-1",
        task: "Créer @/polymet/i18n/locales/fr.ts avec structure complète",
        status: "pending" as const,
      },
      {
        id: "i18n-2",
        task: "Créer @/polymet/i18n/locales/de.ts (copier structure FR)",
        status: "pending" as const,
      },
      {
        id: "i18n-3",
        task: "Créer @/polymet/i18n/locales/it.ts (copier structure FR)",
        status: "pending" as const,
      },
      {
        id: "i18n-4",
        task: "Créer @/polymet/i18n/locales/en.ts (copier structure FR)",
        status: "pending" as const,
      },
      {
        id: "i18n-5",
        task: "Créer @/polymet/i18n/namespaces.ts (types TypeScript)",
        status: "pending" as const,
      },
      {
        id: "i18n-6",
        task: "Créer @/polymet/i18n/validator.ts (script validation)",
        status: "pending" as const,
      },
      {
        id: "i18n-7",
        task: "Créer @/polymet/i18n/index.ts (exports)",
        status: "pending" as const,
      },
    ],
  },
...
// @/polymet/components/viamentor-locale-provider

import { fr } from "@/polymet/i18n/locales/fr";
import { de } from "@/polymet/i18n/locales/de";
import { it } from "@/polymet/i18n/locales/it";
import { en } from "@/polymet/i18n/locales/en";
...
import { validateTranslations } from "@/polymet/i18n/validator";
