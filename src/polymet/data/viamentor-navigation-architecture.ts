...
export const NAVIGATION_ARCHITECTURE = {
  ...
  components: {
    "viamentor-sidebar-link": {
      path: "@/polymet/components/viamentor-sidebar-link",
      lines: 225,
    ...
    "viamentor-sidebar-section": {
      path: "@/polymet/components/viamentor-sidebar-section",
      lines: 230,
    ...
    "viamentor-mobile-sidebar": {
      path: "@/polymet/components/viamentor-mobile-sidebar",
      lines: 235,
    ...
    "viamentor-sidebar-navigation-complete": {
      path: "@/polymet/components/viamentor-sidebar-navigation-complete",
      lines: 245,
  ...
  data: {
    "viamentor-navigation-config": {
      path: "@/polymet/data/viamentor-navigation-config",
      lines: 240,
    ...
    "viamentor-navigation-i18n": {
      path: "@/polymet/data/viamentor-navigation-i18n",
      lines: 220,
    ...
    "viamentor-use-navigation": {
      path: "@/polymet/data/viamentor-use-navigation",
      lines: 220,
  ...
  usage: {
    basic: `
// Basic usage
import { SidebarNavigationComplete } from "@/polymet/components/viamentor-sidebar-navigation-complete";
...
import { useNavigation } from "@/polymet/data/viamentor-use-navigation";
import { SCHOOL_ADMIN_NAV } from "@/polymet/data/viamentor-navigation-config";
...
navigation.updateBadgeCount("students", 50);
    ...
    mobile: `
// Mobile sidebar
import { MobileSidebar } from "@/polymet/components/viamentor-mobile-sidebar";
