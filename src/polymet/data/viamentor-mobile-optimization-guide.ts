 ...
 * Utilisation:
 * ```tsx
 * import { ResponsiveDashboard } from "@/polymet/components/viamentor-responsive-dashboard"
 *
 * <ResponsiveDashboard
 *   kpis={kpisData}
 ...
 * @example
 * ```tsx
 * import { useBreakpoint } from "@/polymet/data/viamentor-responsive-utils"
 *
 ...
 * @example
 * ```tsx
 * import { responsiveClasses } from "@/polymet/data/viamentor-responsive-utils"
 *
 ...
 * @example
 * ```tsx
 * import { useLongPress } from "@/polymet/data/viamentor-touch-gestures"
 *
 ...
 * @example
 * ```tsx
 * import { usePinchZoom } from "@/polymet/data/viamentor-touch-gestures"
 *
