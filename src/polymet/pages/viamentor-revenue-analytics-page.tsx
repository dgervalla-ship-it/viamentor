...
const RevenueOverviewTab = lazy(() =>
  import("@/polymet/components/viamentor-revenue-overview-tab").then(
    (module) => ({ default: module.RevenueOverviewTab })
  )
);
const CohortsAnalysisTab = lazy(() =>
  import("@/polymet/components/viamentor-cohorts-analysis-tab").then(
    (module) => ({ default: module.CohortsAnalysisTab })
  )
);
const ForecastingTab = lazy(() =>
  import("@/polymet/components/viamentor-forecasting-tab").then((module) => ({
    default: module.ForecastingTab,
  }))
);
const ChurnAnalysisTab = lazy(() =>
  import("@/polymet/components/viamentor-churn-analysis-tab").then(
    (module) => ({ default: module.ChurnAnalysisTab })
  )
);
const FinancialReports = lazy(() =>
  import("@/polymet/components/viamentor-financial-reports").then((module) => ({
