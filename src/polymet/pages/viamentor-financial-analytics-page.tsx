...
import { FinancialAnalyticsHeader } from "@/polymet/components/viamentor-financial-analytics-header";
...
const FinancialRatiosSection = lazy(
  () => import("@/polymet/components/viamentor-financial-ratios-section")
);
const PricingAnalysisSection = lazy(
  () => import("@/polymet/components/viamentor-pricing-analysis-section")
);
const PaymentMethodsBreakdownSection = lazy(
  () =>
    import("@/polymet/components/viamentor-payment-methods-breakdown-section")
);
const BudgetTrackingSection = lazy(
  () => import("@/polymet/components/viamentor-budget-tracking-section")
);
...
import { generateForecast } from "@/polymet/data/viamentor-revenue-forecast-ml";
