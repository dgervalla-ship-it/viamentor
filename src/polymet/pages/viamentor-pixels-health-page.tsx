...
import { PixelsHealthDashboard } from "@/polymet/components/viamentor-pixels-health-dashboard";
import { ActiveAlertsSection } from "@/polymet/components/viamentor-active-alerts-section";
import { AutoDiagnostics } from "@/polymet/components/viamentor-auto-diagnostics";
import { EventsLogsSheet } from "@/polymet/components/viamentor-events-logs-sheet";
import { EmailNotificationsConfig } from "@/polymet/components/viamentor-email-notifications-config";
import {
  mockPlatformsHealth,
  mockPixelAlerts,
  mockPixelEvents,
